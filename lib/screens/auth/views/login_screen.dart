      ...
      try {
        ...
        if (response.success && response.data != null) {
          ...
          if (user != null && authToken != null) {
            // 🎯 CRITICAL: Store token DIRECTLY for immediate use
            ...
            // Also save token to ApiService for API calls
            if (authToken != null) {
              final apiService = ApiService();
              await apiService.setAuthToken(authToken);
              print('🔐 Token saved to ApiService: ${authToken.substring(0, 20)}...');
            }
            ...
            print('🔐 Token details: length=${authToken?.length ?? 0}, saved=${authToken != null}');
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: _isLoading 
                        ...
                        : const Text("Log in"), // Generic login text - role determined after login
                  ),
                  Row(
